...
class Environment():
    """
    This class extends the basic version of an environment and allows for the
    possibility of a mutation happening in the creation of the two daughter
    organisms.
    """
    ...
    def update(self):
        ...
        adding two daughter organisms. With a random possibility (currently
        1/10th) the daughter organisms get different mutations. This means that
        their size is randomly increased and their division threshold randomly
        decreased. In the end the food in the environment is refilled
        ...
        for organism in self.population:
            ...
            # whether a mutation should occure or not. If a mutation occurs
            # both daughter organisms get an increased size, a decreased
            # division threshold and an "M" added to their species. Otherwise
            #  they just take those attributes from their parents. For the other
            #  attributes or without mutation they have the same attributes
            # as the parent organism but only half the size.
            elif divide:
