    ...
    def update(self):
        ...
        for organism in self.population:
            ...
            # If the organism returns the division signal True: Remove organism from population & add 2 new (same parameters, size/2)
                ...
                self.gene_pool.append([uptake_rate, metabolic_rate])
                uptake_rate = self.gene_pool[(random.randrange(0,len(self.gene_pool)))][0]
                metabolic_rate = self.gene_pool[(random.randrange(0,len(self.gene_pool)))][1]
